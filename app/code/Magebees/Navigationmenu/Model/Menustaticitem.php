            ...
            /* Check CMS Page is Active & From the Current Store Visible Or not*/
                ...
                if (( $current_category->getId()) && ($allow_cat == "1")) {
                    ...
                    if ($current_category->getLevel() != '1') {
						...
						$this->url =  $this->_helper->getCategoryUrl($cat_id,$current_storeid);
                    } else {
            ...
            Here Check Column Layout which is greater then the one column and menu type is
                ...
                if ((($item->getShowCategoryImage() != 'none') || ($item->getShowCustomCategoryImage() == '1')) && ($item->getType() == "2")) {
                    if ($item->getShowCustomCategoryImage() == '1') {
                        $image_url= $this->_current_store->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA).'navigationmenu/image/'.$item->getImage();						$img_alt = $item->getImgAlt();						if($img_alt):						  $image_tag = "<span class=img><img src='".$image_url."' alt='".$img_alt."'/></span>";						else:						  $image_tag = "<span class=img><img src='".$image_url."' /></span>";						endif;
                        ...
                        if ($category_image->getImageUrl() != '') {
                            ...
                            $image_tag = "<span class=img><img src='".$image_url."' alt='".$category_image->getName()."' /></span>";
                        }
                    }
                } else {
                ...
                */
                ...
                if ((($item->getShowCategoryImage() != 'none') || ($item->getShowCustomCategoryImage() == '1')) && ($item->getType() == "2")) {
                    if ($item->getShowCustomCategoryImage() == '1') {
                        ...
                        $img_alt = $item->getImgAlt();						if($img_alt):						  $image_tag = "<span class=img><img src='".$image_url."' alt='".$img_alt."' /></span>";						else:						  $image_tag = "<span class=img><img src='".$image_url."' /></span>";						endif;						
                    } elseif ($item->getShowCategoryImage() == 'main_image') {
                        $cat_id = $item->getCategoryId();
                        $category_image =$this->_category->create()->load($cat_id);
                        if ($category_image->getImageUrl() != '') {
            ...
            if ($item_menu_level <= $group_level) {
                ...
                if (($group_menutype != "list-item") && ($this->autosub_has_smart_expand == "1")) {
                   // $html .= '<a href='.$category->getUrl($category).' class="Level'.$item_menu_level.'" title="'.$category->getName().'">';
					$categoryUrl = $this->_helper->getCategoryUrl($category->getId(),$store_id);
					$html .= '<a href='.$categoryUrl.' class="Level'.$item_menu_level.'" title="'.$category->getName().'">';
                        ...
                        if ($cat_image_type != 'none') {
                            if ($cat_image_type == 'thumbnail_image') {
                                if ($category->getThumbnail() != '') {
                                    ...
                                    $html .= "<span class=img><img 2504 src='".$image_url."' alt='".$category_image->getName()."'/></span>";
                                }
                            } elseif ($cat_image_type == 'main_image') {
                                if ($category->getImageUrl() != '') {
                                    $image_url = $category->getImageUrl();
                                    $html .= "<span class=img><img 2514 src='".$image_url."' alt='".$category_image->getName()."' /></span>";
                                }
                            }
                        }
                    }
                        ...
                        if ($cat_image_type != 'none') {
                            if ($cat_image_type == 'thumbnail_image') {
                                if ($category->getThumbnail() != '') {
                                    ...
                                    $html .= "<span class=img><img 2554 src='".$image_url."' alt='".$category_image->getName()."' /></span>";
                                }
                            } elseif ($cat_image_type == 'main_image') {
                                if ($category->getImageUrl() != '') {
                                    $image_url = $category->getImageUrl();
                                    $html .= "<span class=img><img 2564 src='".$image_url."' alt='".$category_image->getName()."' /></span>";
                                }
                            }
                        }
                    }
