...
namespace Magebees\CacheWarmer\Model\HolePunch;
...
{
    public const START_TAG_BEGIN = '<!--[magebees_holepunch_tag_start_begin';
    public const START_TAG_END = 'magebees_holepunch_tag_start_end]-->';
    public const END_TAG_BEGIN = '<!--[magebees_holepunch_tag_end_begin';
    public const END_TAG_END = 'magebees_holepunch_tag_end_end]-->';
    public const SEPARATOR = '___';
    public const SEARCH_PATTERN = '/<!--\[magebees_holepunch_tag_start_begin(.*?)magebees_holepunch_tag_start_end]-->/i';
    public const WIDGET_BLOCK_REPLACER_PATTERN = '/<\/div>\n?<!--\[magebees_holepunch_tag_end_begin/im';

    public const BLOCK_CLASS = 'block_class';
    public const MODULE_NAME = 'module_name';
    public const LAYOUT_NAME = 'layout_name';
    public const TEMPLATE = 'template';
    public const TEMPLATE_FILE = 'template_file';
    public const CMS_WIDGET_ID = 'cms_widget_id';
    public const ARGUMENTS = 'arguments';

    /**
     * @var \Magebees\CacheWarmer\Model\HolePunch\BlockArgumentsRegistry
     */
