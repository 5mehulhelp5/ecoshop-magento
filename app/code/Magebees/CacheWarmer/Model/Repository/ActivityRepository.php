...
use Magebees\CacheWarmer\Api\ActivityRepositoryInterface;
use Magebees\CacheWarmer\Api\Data\ActivityInterface;
use Magebees\CacheWarmer\Model\ActivityFactory;
use Magebees\CacheWarmer\Model\ResourceModel\Activity as ActivityResource;
use Magebees\CacheWarmer\Model\ResourceModel\Activity\Collection;
...
class ActivityRepository implements ActivityRepositoryInterface
{
    ...
    {
        // Update data is faster than Insert (insertOnDuplicate).
        try {
            $activityId = $this->activityResource->matchUrl(
                $activity->getUrl(),
                $activity->getMobile(),
                $activity->getStore(),
                $activity->getCurrency(),
                $activity->getCustomerGroup()
            );
    ...
    public function getById($id)
    {
        if (!isset($this->activitys[$id])) {
            /** @var \Magebees\CacheWarmer\Model\Activity $activity */
            $activity = $this->activityFactory->create();
    ...
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        /** @var \Magebees\CacheWarmer\Model\ResourceModel\Activity\Collection $activityCollection */
